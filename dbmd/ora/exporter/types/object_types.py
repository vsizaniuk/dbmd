...
class TypesExporter(Exporter):
    ...
    async def get_collection_types(self):
        ...
        def query_f():
            ...
            return sql.get_collection_types(conn, self.schema, self.name)
    ...
    async def get_scalar_types(self):
        ...
        def query_f():
            ...
            return sql.get_scalar_types(conn, self.schema, self.name)
    ...
    async def get_object_types(self):
        ...
        def query_f():
            ...
            return sql.get_object_types(conn, self.schema, self.name)
    ...
    async def get_object_types_definitions(self):
        ...
        def query_f():
            ...
            return sql.get_object_types_definitions(conn, self.schema, self.name)
